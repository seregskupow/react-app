...
import prodImg from "../images/singleProductBcg.jpeg";

export default function SingleProductPage() {
  return (
    <>
      <Hero img={prodImg} title="single product" />
      <ProductConsumer>
        {value => {
              ...
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-10 mx-auto col-sm-8 col-md-6 my-3">
                    ...
                    <h5 className="text-capitalize text-,uted mb-4">company: {company}</h5>
                    <h5 className="text-main text-capitalize mb-4">price: ${price}</h5>
                    <p className="text-capitalize text-title mt-3">Info about product : </p>
                    <p>{description}</p>
